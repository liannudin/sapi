                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;        
                    foreach($uncategorized as $na){ 
                    ?>
                        <tr>
                          <td><?php echo $no ?></td>
                          <td><?php echo $na->nama_kategori ?></td>
                          <td><?php echo $na->deskripsi ?></td>
                          <td></td>
                        </tr>
                      <?php } ?>
                    ...
                    ?>
                        <tr>
                          ...
                          <td>
                              <?php echo anchor('kategori/edit/'.$u->id_kategori,'<button class="btn btn-sm btn-primary" >  Edit </button>'); ?>
                              <?php echo anchor('admin/kategori/hapus/'.$u->id_kategori,'<button class="btn btn-sm btn-danger" >  Hapus </button>'); ?>
                          </td>
                        </tr>
                      <?php } ?>
    ...
    function tambahData()
{
    ...
    $('.modal-title').text('Kategori Baru'); // Set Title to Bootstrap modal title
}
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo base_url('admin/kategori/add')?>";
    } else {
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            if(data.status) //if success close modal and reload ajax table
            {
                ...
                location.reload();//Untuk Reload Ajax
            }
            else
            {
